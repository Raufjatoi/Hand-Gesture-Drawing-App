...
def draw_buttons():
    ...
    # Shape buttons
    paintWindow = cv2.rectangle(paintWindow, (700, 1), (770, 65), (0,0,0), 2)
    cv2.putText(paintWindow, "CIRCLE", (710, 33), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2, cv2.LINE_AA)
    paintWindow = cv2.rectangle(paintWindow, (780, 1), (850, 65), (0,0,0), 2)
    cv2.putText(paintWindow, "RECT", (790, 33), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2, cv2.LINE_AA)
        ...
        if (thumb[1] - center[1] < 30):
            ...
            if 40 <= center[0] <= 140:  # Clear Button
                ...
                for i in range(len(color_names)):
                    if 160 + i*90 <= center[0] <= 255 + i*90:
                        colorIndex = i
                        eraser_on = False
                        shape_mode = None
                if 700 <= center[0] <= 770:
                    shape_mode = "circle"
                elif 780 <= center[0] <= 850:
